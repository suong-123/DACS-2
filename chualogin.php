        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin: 7px;">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                    <li class="nav-item" >
                        <a class="nav-link active me-2" aria-current="page" href="chualogin.php">Trang chủ</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container availability-form">
        <div class="row">
            <div class="col-lg-12 bg-white shadow p-4 rounded">
                ...
                <form action="./room_timkiem.php" method="get">
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <!-- <button class="btn btn-sm text-white custom-bg shadow-none py-3 px-5 mt-2" href="" style="font-size: 20px;">Tìm hiểu thêm</button> -->
                ...
                <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-evenly mb-2">
                            ...
                            <a href="chitietphong.php?id= <?php echo $row['maphong'] ?>" class="btn btn-sm btn-outline-dark shadow-none">Xem chi tiết</a>
                        </div>
                    </div>
                </div>
            </div> <?php }   ?>
