        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form action="timkiemuser.php" method="post"
                ...
                <!-- Begin Page Content -->
                    <a style="margin-left: 85%;width: 120px;" class="btn btn-outline-dark shadow-none me-lg-2 me-2" href="formthemuser.php" ><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới </a><br><br>
                    <div class="table-responsive">
                        <div class="container-fluid">
                            <table class="table table-hover boder text-center" >
                                <thead>
                                    <tr class="table-info">
                                        <th>#</th>
                                        <th>Ảnh</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td> <?php echo $i++ ?> </td>
                                        <td>
                                            <img style="width: 140px;" src="../img/<?php echo $row['ava'] ?> "><br>
                                        ...
                                        <td><?php 
                                            if($row['status'] == 1){
                                                echo '<a href="active.php?id='.$row['id'].'&status=0" class="btn btn-success btn-sm shadow-non">
                                                        active
                                                    </a>';
                                            }else{
                                                echo '<a href="active.php?id='.$row['id'].'&status=1" class="btn btn-danger btn-sm shadow-non">
                                                        inactive
                                                    </a>';
                                            }
                                        ...
                                        ?></td>
                                        <td>
                                            <a  class="btn" href="formsuauser.php?id= <?php echo $row['id'] ?>"> <i class="fas fa-edit" style="color: black;"></i></a>
                                            <a onclick="return confirm('Bạn có muốn xóa <?php echo $row['username']; ?> này không?');" href="xoauser.php?id= <?php echo $row['id'] ?>" class="btn" > <i class="fas fa-trash" style="color: red;"></i></a>
                                        </td>
                                    </tr>
