<?php
    ...
    if(isset($_POST['sbm'])){
        ...
        $sql = "UPDATE users SET username='$name',ava='$image',cccd='$cccd',
                address='$address',phone='$phone',email='$email',pass='$pass' WHERE id=$id";
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <input type="text" class="form-control shadow-none" value="<?php echo $r['username']?>" name="name" required>
                                </div>
                                <div class="col-sm">
                                ...
                                <div class="col-sm">
                                    ...
                                    <input type="text" class="form-control shadow-none" value="<?php echo $r['cccd']?>" name="cccd" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm">
                                    <label class="form-label">Địa chỉ</label>
                                    <input type="text" class="form-control shadow-none" value="<?php echo $r['address']?>" name="address" required>
                                </div>
                                <div class="col-sm">
                                    <label class="form-label">Số điện thoại</label>
                                    <input type="text" class="form-control shadow-none" value="<?php echo $r['phone']?>" name="phone" required>
                                </div>
                                <div class="col-sm">
                                    <label class="form-label">Email</label>
                                    <input type="text" class="form-control shadow-none" value="<?php echo $r['email']?>" name="email" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm">
                                    <label class="form-label">Mật khẩu</label>
                                    <input type="text" class="form-control shadow-none" value="<?php echo $r['pass']?>" name="pass" required>
                                </div>
                            </div><br>
                        <button name="sbm" type="submit" style="margin-left: 40px;width: 120px;" class="btn btn-primary"> Sửa </button>
