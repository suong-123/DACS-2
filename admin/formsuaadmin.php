<?php
    ...
    $id = $_GET['id'];
    $sql_all = "SELECT * FROM adminlogin  WHERE stt=$id";
    ...
    if(isset($_POST['sbm'])){
       ...
       if($_FILES['image']['name']==''){
        ...
        $sql_sua = "UPDATE adminlogin SET admin_name='$name', admin_pass='$pass', anh='$image'
                        WHERE stt = $id";
        $query_sql = mysqli_query($conn,$sql_sua);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <input type="text" class="form-control shadow-none" value="<?php echo $r['admin_name']?>" name="name" required>
                                </div>
                                <div class="col-sm">
                                    <label class="form-label">Mật khẩu</label>
                                    <input type="text" class="form-control shadow-none" value="<?php echo $r['admin_pass']?>" name="pass" required>
                                </div>
                                <div class="col-sm">
                        ...
                        <a class="btn btn-outline-dark" href="admin.php" >Danh sách</a>
                    </form>
                    </div>
                </div>
