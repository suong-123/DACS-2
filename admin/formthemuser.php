<?php
    ...
    if(isset($_POST['sbm'])){
        ...
        $sql = "INSERT INTO users(username,ava,cccd,address,phone,email,pass)
                 VALUES ('$name','$image','$cccd','$address','$phone','$email','$pass') ";
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    ...
                                    <input type="text" class="form-control shadow-none" name="cccd" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm">
