<?php
    ...
    $id = $_GET['id'];
    $sql_all = "SELECT * FROM phong WHERE maphong=$id";
    ...
    if(isset($_POST['sbm'])){
        ...
        $sql = "UPDATE phong SET tenphong='$tenphong', anh='$image', gia='$gia',
                nguoilon='$nguoilon',treem=$treem, mota='$mota', nameloaiphong='$loaiphong' WHERE maphong=$id";
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <input type="text" class="form-control shadow-none" name="tenphong" value="<?php echo $r['tenphong']?>" required>
                                </div>
                                <div class="col-sm">
                                ...
                                <div class="col-sm">
                                    ...
                                    <input type="text" class="form-control shadow-none" name="gia" value="<?php echo $r['gia']?>" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm">
                                    <label class="form-label">Người lớn</label>
                                    <input type="text" class="form-control shadow-none" name="nguoilon" value="<?php echo $r['nguoilon']?>" required>
                                </div>
                                <div class="col-sm">
                                    <label class="form-label">Trẻ em</label>
                                    <input type="text" class="form-control shadow-none" name="treem" value="<?php echo $r['treem']?>" required>
                                </div>
                                <div class="col-sm">
                                    <label class="form-label">Mô tả</label>
                                    <input type="text" class="form-control shadow-none" name="mota" value="<?php echo $r['mota']?>" required>
                                </div>
                                <div class="col-sm">
