        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form action="timkiembooking.php" method="post"
                ...
                <!-- Begin Page Content -->
                <a style="margin-left: 85%;width: 120px;" class="btn btn-outline-dark shadow-none me-lg-2 me-2" href="formthembooking.php" ><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới </a><br><br>
                <div class="container-fluid">
                        <table class="table" style="overflow-x: scroll;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td> <?php echo $i++ ?></td>
                                    <td><label style="font-weight: bold; font-size: 18px;"><?php echo $row['tenkh'] ?></label> <br>
                                    <?php echo $row['phonekh'] ?></td>
                                    ...
                                    <td>
                                        <a onclick="return confirm('Bạn có muốn xóa khách hàng <?php echo $row['tenkh']; ?> này không?');" href="xoabooking.php?id=<?php echo $row['id_book'] ?>" class="btn" ><i class="fas fa-trash" style="color: red;"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
