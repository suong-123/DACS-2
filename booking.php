                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating date" id="date3" data-target-input="nearest">
                            <input type="date" class="form-control datetimepicker-input" id="checkin" placeholder="Check In" data-target="#date3" data-toggle="datetimepicker" />
                            <label for="checkin">Check In</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-floating date" id="date4" data-target-input="nearest">
                            <input type="date" class="form-control datetimepicker-input" id="checkout" placeholder="Check Out" data-target="#date4" data-toggle="datetimepicker" />
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            ...
                            <label for="select1">NGƯỜI LỚN</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-floating">
                            ...
                            <label for="select2">TRẺ EM</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating">
                            ...
                            <label for="select3">LOẠI PHÒNG</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating">
                            <textarea class="form-control" placeholder="Special Request" id="message" style="height: 100px"></textarea>
                            <label for="message">Yêu cầu đặt biệt</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <button onclick="myFunction()" class="btn btn-primary text-white py-3" style="margin-left: 220px; font-size: 20px; width:250px" type="submit">Đặt ngay</button>
                    </div>
                </div>
            </form>                                            
            </div>            
